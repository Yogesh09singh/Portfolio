    ...
    <section id="about" className="py-24 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <RevealOnScroll className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="font-sora text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
          {/* Executive Bio Card */}
          <RevealOnScroll delay={0.1} className="lg:col-span-7 h-full">
            <div className="glass-card p-8 rounded-3xl flex flex-col justify-between h-full">
              <div>
          ...
          {/* Education Card */}
          <RevealOnScroll delay={0.2} className="lg:col-span-5 h-full">
            <div className="glass-card p-8 rounded-3xl flex flex-col justify-between relative overflow-hidden h-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {PORTFOLIO_DATA.achievements.map((achieve, i) => (
            <RevealOnScroll key={i} delay={0.1 * i} blur={false}>
              <div className="glass-card p-5 rounded-2xl flex items-start space-x-3 hover:border-primaryIndigo/40 transition-colors">
